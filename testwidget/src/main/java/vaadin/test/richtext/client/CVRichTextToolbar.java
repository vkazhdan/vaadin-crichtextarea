 ...
 */
public class CVRichTextToolbar extends Composite {
   ...
   private class EventHandler implements ClickHandler, ChangeHandler,
      ...
      public void onClick(ClickEvent event) {
         ...
         if (sender == bold) {
            ...
            basic.setJustification(CRichTextArea.Justification.LEFT);
         } else if (sender == justifyCenter) {
            basic.setJustification(CRichTextArea.Justification.CENTER);
         } else if (sender == justifyRight) {
            basic.setJustification(CRichTextArea.Justification.RIGHT);
   ...
   private static final CRichTextArea.FontSize[] fontSizesConstants = new CRichTextArea.FontSize[] {
           CRichTextArea.FontSize.XX_SMALL, CRichTextArea.FontSize.X_SMALL,
           CRichTextArea.FontSize.SMALL, CRichTextArea.FontSize.MEDIUM,
           CRichTextArea.FontSize.LARGE, CRichTextArea.FontSize.X_LARGE,
           CRichTextArea.FontSize.XX_LARGE };
   ...
   private final CRichTextArea richText;
   @SuppressWarnings("deprecation")
   private final CRichTextArea.BasicFormatter basic;
   @SuppressWarnings("deprecation")
   private final CRichTextArea.ExtendedFormatter extended;
    ...
    */
   @SuppressWarnings("deprecation")
   public CVRichTextToolbar(CRichTextArea richText) {
