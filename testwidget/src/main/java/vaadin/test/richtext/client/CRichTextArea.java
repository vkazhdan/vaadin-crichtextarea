 ...
 * </dl>
 */
public class CRichTextArea extends FocusWidget implements HasHTML,
    ...
    * {@link CRichTextArea#getBasicFormatter()} will return an instance of this
    * class.
    * </p>
    * <p>
    * The formatter will format the user selected text in the
    * {@link CRichTextArea}. As a result, it will only work reliably if the
    * {@link CRichTextArea} is attached, visible to on the page, and has been
    * focused at least once. If you just want to initialize the content of the
    * {@link CRichTextArea}, use {@link CRichTextArea#setHTML(String)} instead.
    * </p>
    *
    * @deprecated use {@link CRichTextArea.Formatter} instead
    */
   @Deprecated
    ...
    * {@link CRichTextArea#getExtendedFormatter()} will return an instance of this
    * class.
    * </p>
    * <p>
    * The formatter will format the user selected text in the
    ...
    * This interface is used to access full formatting options, when available.
    * If the implementation supports full formatting, then
    * {@link CRichTextArea#getFormatter()} will return an instance of this class.
    * </p>
    * <p>
    * The formatter will format the user selected text in the
    * {@link CRichTextArea}. As a result, it will only work reliably if the
   ...
   /**
    * Creates a new, blank {@link CRichTextArea} object with no stylesheet.
    */
    ...
    * only be done when the {@link CRichTextArea} is attached, visible on the
    ...
    * be done when the {@link CRichTextArea} is attached, visible on the page, and
    ...
    * done when the {@link CRichTextArea} is attached, visible on the page, and
    * has been focused by the user.
    *
    * @return <code>null</code> if full formatting is not supported
    */
